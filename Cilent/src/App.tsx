...
import { ShieldAlert, RefreshCw, PanelLeft, Sparkles, MessageSquare, Plus } from "lucide-react";
import Sidebar from "./components/Sidebar";
import EmptyState from "./components/EmptyState";
import ChatFeed from "./components/ChatFeed";
import ScoreScreen from "./components/ScoreScreen";
import InputArea from "./components/InputArea";
import { Message, DebateChat, ScoreResponse, ScreenState } from "./types";
...
export default function App() {
  ...
  const [chats, setChats] = useState<DebateChat[]>(() => {
  ...
  const updateActiveChat = (fields: Partial<DebateChat>) => {
  ...
  const handleStartDebate = async (opinionVal: string) => {
    setErrorBanner(null);
