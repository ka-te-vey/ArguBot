...
The debate topic started with the user's opinion: "${opinion}". You must hold the opposite stance and refute their arguments.`;
  ...
  app.listen(PORT, "localhost", () => {
    ...
    console.log(`\n  \x1b[1m\x1b[32mVITE v6.2.3\x1b[0m  ready in 350 ms\n`);
    console.log(`  \x1b[32m➜\x1b[0m  \x1b[1mLocal:\x1b[0m   \x1b[36m${url}\x1b[0m`);
    console.log(`  \x1b[32m➜\x1b[0m  \x1b[1mNetwork:\x1b[0m use --host to expose\n`);

    // Replicate Vite's keyboard shortcut "o" to open browser in dev mode
    if (process.env.NODE_ENV !== "production") {
