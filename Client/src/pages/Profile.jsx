...
import LampContainer from "../Effect/LampEffect";
    ...
    >
      ...
      <motion.div
        ...
        className={`w-full max-w-lg rounded-3xl border shadow-2xl backdrop-blur-md z-10 overflow-hidden transition-all relative ${
          isDark
            ? "bg-[#1E1E1F] border-zinc-800 shadow-purple-950/40 text-[#E3E3E3]"
            : "bg-white border-zinc-200 shadow-zinc-200/60 text-[#1F1F1F]"
        }`}
      >
        <LampContainer isDark={isDark} className="w-full">
          ...
          <div className="px-6 md:px-8 pb-6 pt-0 relative w-full">
            ...
            <form onSubmit={handleSaveProfile} className="space-y-5">
              ...
              {/* Action Buttons Row: Back + Save Profile Changes */}
              <div className="pt-2 flex items-center gap-3">
                <motion.button
                  whileTap={{ scale: 0.98 }}
                  type="button"
                  onClick={() => navigate("/")}
                  className={`px-5 py-3.5 font-bold rounded-2xl text-sm transition-all border flex items-center justify-center gap-2 cursor-pointer shrink-0 ${
                    isDark
                ...
                <motion.button
                  ...
                  type="submit"
                  disabled={isSaving}
                  className={`flex-1 py-3.5 argubot-cta-btn font-bold rounded-2xl text-sm transition-all shadow-lg flex items-center justify-center gap-2 cursor-pointer ${
