      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className={`text-xs mt-1 ${isDark ? "text-zinc-400" : "text-zinc-500"}`}>
            Log in to enter the critical debate arena.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex items-center gap-2">
            <input
              id="remember"
              type="checkbox"
              className="w-4 h-4 accent-purple-500 bg-zinc-50 dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800 rounded focus:ring-purple-500"
            />
            <label htmlFor="remember" className={`text-xs cursor-pointer select-none ${isDark ? "text-zinc-400" : "text-zinc-500"}`}>
              Keep me signed in
            </label>
          </div>
